...
{
    public partial class XtraReport_BangDiemTotNghiepAnhVietA3_KCQ : DevExpress.XtraReports.UI.XtraReport
    {
        #region Variables
        ...
        #region public XtraReport_BangDiemTotNghiepAnhVietA3_KCQ()
        public XtraReport_BangDiemTotNghiepAnhVietA3_KCQ()
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void GroupHeader2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                this.xrSubreport_TiengAnh_Trai.ReportSource = new XtraReport_BangDiemTNA3_TiengAnh_Trai_KCQ();
                this.xrSubreport_TiengAnh_Trai.BeforePrint += new PrintEventHandler(this.xrSubreport_TiengAnh_Trai_BeforePrint);

                this.xrSubreport_TiengAnh_Phai.ReportSource = new XtraReport_BangDiemTNA3_TiengAnh_Phai_KCQ();
                this.xrSubreport_TiengAnh_Trai.BeforePrint += new PrintEventHandler(this.xrSubreport_TiengAnh_Phai_BeforePrint);

                this.xrSubreport_TiengViet_Trai.ReportSource = new XtraReport_BangDiemTNA3_TiengViet_Trai_KCQ();
                this.xrSubreport_TiengViet_Trai.BeforePrint += new PrintEventHandler(this.xrSubreport_TiengViet_Trai_BeforePrint);

                this.xrSubreport_TiengViet_Phai.ReportSource = new XtraReport_BangDiemTNA3_TiengViet_Phai_KCQ();
