...
{
    public partial class XtraReport_Yersin_DanhSachSVKhongDatTN_NhomAV : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReport_Yersin_DanhSachSVKhongDatTN_NhomAV()
        {
            InitializeComponent();
        }
