...
{
    public partial class XtraReport_Yersin_KetQuaXepLoaiBangTN_NienChe : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReport_Yersin_KetQuaXepLoaiBangTN_NienChe()
        {
            InitializeComponent();
        }
        ...
        public void Init_Report(DataTable tbPrint, string _NgayIn, string _NguoiLap, bool groupBacHe, bool groupKhoa, string _AdministrativeUnit, string _CollegeName)
        {
            ...
            if (groupBacHe == true)
            {
                ...
                this.xrTableCell_TBKha_1.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", null, "TBKha") });
            ...
            if (groupKhoa == true)
            {
                ...
                this.xrTableCell_TBKha_2.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", null, "TBKha") });
            ...
            this.xrTableCell_TBKha_3.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", null, "TBKha") });
