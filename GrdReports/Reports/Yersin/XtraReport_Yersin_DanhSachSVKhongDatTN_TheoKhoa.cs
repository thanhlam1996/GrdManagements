...
{
    public partial class XtraReport_Yersin_DanhSachSVKhongDatTN_TheoKhoa : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReport_Yersin_DanhSachSVKhongDatTN_TheoKhoa()
        {
            InitializeComponent();
        }
